                        ...
                        <div class="cs-dropdown">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="achievements">
                                  <li><a class="dropdown-item" href="#">التأمين الصحي</a></li>
                                  <li><a class="dropdown-item" href="#">الاستشارات القانونية</a></li>
                                </ul>
                              </div>
                        </div>
                    </li>
                            ...
                            <div class="text-center no-requests">
                                <div class="row justify-content-center">
                                    <div class="col-md-4 col-sm-6">
                                        <figure>
                                            <img src="assets/images/no-requests.svg" alt="" srcset="">
                                        </figure>
                                        <h6>لا طلبات</h6>
