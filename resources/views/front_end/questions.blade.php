                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio1">
                                                    <span>1</span>
                                                    طب وجراحة العيون
                                                </label>
                                              </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio2">
                                                    <span>2</span>
                                                    طب وجراحة الأعصاب
                                                </label>
                                              </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio3">
                                                    <span>3</span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio4">
                                                    <span>4</span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio5">
                                                    <span>5</span>
                                                    طب وجراحة العظام
                                                </label>
                                              </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio6">
                                                    <span>6</span>
                                                    طب النساء والتوليد
                                                </label>
                                              </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio7">
                                                    <span>7</span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="btn-group" role="group">
                                                ...
                                                <label class="btn cs-checkbox" for="btnradio8">
                                                    <span>8</span>
                                                    طب الأطفال
                                                </label>
                                              </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="d-flex justify-content-between align-items-end">
                        <a href="#" class="btn cs-btn prev">السابق</a>
                        <a href="q2.html" class="btn cs-btn v2 next">التالي</a>
                    </div>
                </div>
            </div>
        </div>
