        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">                                               
                      <h3>تأكيد الحذف</h3>
                      <p>
                        هل أنت متأكد من انك تريد حذف عرض السعر
                        من قائمة الطلبات الخاصة بك ؟
                      </p>
                      <div class="d-flex justify-content-center gap-3">
                        <a href="#" class="btn cs-btn cancel"  data-bs-dismiss="modal" aria-label="Close">
                            إلغاء
                        </a> 
                        <a href="#" class="btn cs-btn v2 cs-btn-red">
                            حذف
                        </a> 
