                                    ...
                                    <div class="hospital-media-body">
                                        <div class="hospital-media-body_title">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="rate">
                                                            @php
                                                                ...
                                                                $average =
                                                                    $count > 0 ? $hostpial->ratings->avg('rating') : 0;
                                                            @endphp
                                                            <span>
                                            ...
                                            <div class="hospital-media-body_description">
                                                {{ Str::words($hostpial->description, 10) }}
                                            </div>
                                                    ...
                                                    <div class="info">
                                                        <span class="me-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                height="20.75" viewBox="0 0 18 20.75">
                                                                <g id="vuesax_bulk_calendar"
