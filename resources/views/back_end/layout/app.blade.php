                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('doctors.index') }}">
                                                ...
                                                <span class="menu-title">{{__('site.all')}} {{__('site.doctors')}} </span>
                                            </a>
                                        </div>
                                        @endcan
                                        @can('Add Doctor')
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('doctors.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{ __('site.doctor') }} </span>
                                            </a>
                                        </div>
                                        @endcan
                                    </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ route('hospitals.index') }}">
                                                    ...
                                                    <span class="menu-title">{{ __('site.all') }} {{ __('site.hospitels') }} </span>
                                                </a>
                                            </div>
                                        </div>
                                    @endcan
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        @can('Show all Operations')
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ route('operations.index') }}">
                                                    ...
                                                    <span class="menu-title">{{ __('site.all') }} {{__('site.operations')}} </span>
                                                </a>
                                            </div>
                                        @endcan
                                        @can('Add Operation')
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('operations.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.operation')}}</span>
                                            </a>
                                        </div>
                                        @endcan
                                    </div>
                                    ...
                                    {{-- @can('Show all Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('roles.index') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.all') }} {{__('site.rolrs')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                    {{-- @can('Add Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('roles.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.rolr')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                </div>
                                    ...
                                    {{-- @can('Show all Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('offers.index') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.all') }} {{__('site.offers')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                    {{-- @can('Add Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('offers.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.offer')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                </div>
                                    ...
                                    {{-- @can('Show all Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('countries.index') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.all') }} {{__('site.countries')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                    {{-- @can('Add Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('countries.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.country')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                </div>
                                    ...
                                    {{-- @can('Show all Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('cities.index') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.all') }} {{__('site.cities')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                    {{-- @can('Add Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('cities.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.city')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                </div>
                                    ...
                                    {{-- @can('Show all Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('specializations.index') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.all') }} {{__('site.specializations')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                    {{-- @can('Add Roles') --}}
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('specializations.create') }}">
                                                ...
                                                <span class="menu-title">{{ __('site.add') }} {{__('site.specialization')}} </span>
                                            </a>
                                        </div>
                                    {{-- @endcan --}}
                                </div>
                              ...
                              <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('users.index') }}">
                                            ...
                                            <span class="menu-title">{{ __('site.all') }} {{__('site.users')}} </span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('users.create') }}">
                                            ...
                                            <span class="menu-title">{{ __('site.add') }} {{__('site.user')}} </span>
                                        </a>
                                    </div>
                                </div>
                                <div class="menu-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">{{ __('site.add') }} Product</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">{{ __('site.add') }} Category</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                            ...
                                                            <div class="menu-sub menu-sub-accordion">
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        ...
                                                                        <span class="menu-title">{{ __('site.add') }} Order</span>
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                ...
                                                                <span class="menu-title">{{ __('site.add') }} Subscription</span>
                                                            </a>
                                                        </div>
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                        ...
                                        <div class="py-2 text-center border-top">
                                            <a href="../../demo1/dist/pages/user-profile/activity.html"
                                                class="btn btn-color-gray-600 btn-active-color-primary">View {{ __('site.all') }}
